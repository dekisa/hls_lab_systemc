...
HD_PWD='C:/Users/hls_proj_2/vivado/addb/addb.runs/base_zynq_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log base_zynq_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source base_zynq_processing_system7_0_0.tcl
